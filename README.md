...
│   ├── gemini_client.py                # Gemini model client (experimental)
│   ├── requirements.txt                # Python dependencies
│   ├── Dockerfile                      # Container definition
│   ├── .env                            # API keys (create this)
│   └── OAI_CONFIG_LIST.json            # Model configuration
│
...
│   ├── AUTOGEN_INTEGRATION.md          # AutoGen integration
...
### Token Limit Issue (High Priority)

**Problem:** Large sequence datasets (100+ sequences, ~292KB) exceed GPT-4's 10,000 token limit.
...
Requests with 20-30 sequences work reliably.

**Planned Fix:**
1. Implement sequence chunking
2. Add sequence filtering/selection logic
3. Use RAG (Retrieval Augmented Generation)
4. Switch to gpt-4-turbo (higher token limit)
...
🔬 **Experimental:**
- Gemini model support (alternative to OpenAI)
- Streaming responses
